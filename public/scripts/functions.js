...
$(document).ready(function(){
	...
	$("#nav > li > a").click(function(){
		var id = $("#userList img").attr("id");
		if(id == "imgtwo"){
			if(document.getElementById(id).style.display == "none"){
				document.getElementById('imgtwo').style.display = "";
	...
	a.fn.bPopup = function(f, j) {
			...
			.hide(function() {
				...
				if (o.loadUrl != null) {
					...
					case "ajax":
						...
						break;
					case "iframe":
						a('<iframe width="100%" height="100%"></iframe>')
						.attr("src", o.loadUrl)
					...
					case "xlink":
						...
						a("a#bContinue .btnLink").text(
								a("a.xlink").attr("title"));
					}
				}
		...
		function i() {
			...
			c.fadeOut(o.fadeSpeed, function() {
				o.loadUrl != null && o.content != "xlink"
		...
		function l() {
			return e.width() < a("body").width() ? 0 : (a("body").width() - e
					.width()) / 2;
		}
		function p(b, k) {
			var q = (e.height() - b.outerHeight(true)) / 2 - k, v = (e.width() - b
					.outerWidth(true))
					/ 2 + l();
			return [ q < 20 ? 20 : q, v ];
		}
		...
		var c = a(this), n = a('<div id="bModal"></div>'), d = a(document), e = a(window), r = p(
				c, o.amsl), g = r[0], h = r[1], m = a.browser.msie
				&& parseInt(a.browser.version) == 6
...
$(document).ready(function() {
	...
	// $('table.area').visualize({type: 'area', height: '300px', width:
	// '620px'});
	// $('table.line').visualize({type: 'line', height: '300px', width:
	// '620px'});
});
